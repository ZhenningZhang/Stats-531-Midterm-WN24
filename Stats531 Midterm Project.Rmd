...
Lingqi Huang: performed basic exploratory data analysis, conducted ARMA model selection, structured ARMA model selection, structure the basic report, and offered some mathematical background knowledge to support the methodology.

Heyuan Liu: brainstorm, write, refine and format the report, provide several visualizations, and build several models.

Zhenning Zhang: project management, wrote the conclusion part of the report, adjustments on aesthetics and format of the report.
